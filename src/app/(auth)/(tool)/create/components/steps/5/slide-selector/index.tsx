...
const SlideSelector = ({shouldHideToolbar}: {shouldHideToolbar: boolean}) => {
  ...
  return (
    <div
      className=" h-[100px] w-full items-center justify-start  overflow-hidden flex flex-row relative bg-background p-2 pb-0 border shadow-md rounded-md "
      style={{width: "900px"}}
    >
      <ScrollArea
        onScroll={onScroll}
      ...
      >
        <div className="flex   flex-row w-fit  h-full justify-start items-start gap-4 z-20  relative ">
